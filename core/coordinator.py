...
class ResumeExtractor:
    ...
    def __init__(self, extractors: Dict[str, FieldExtractor]):
        ...
        Args:
            extractors (Dict[str, FieldExtractor]): Mapping of field names to extractors.
        """
        if not extractors:
...
class ResumeParserFramework:
    ...
    def __init__(self, parsers: Dict[str, FileParser], extractor_coordinator: ResumeExtractor):
        """
        ...
        Args:
            ...
            extractor_coordinator (ResumeExtractor): The engine that handles field extraction.
        """
